apos.define('apostrophe-areas-editor', {
  construct: function(self, options) {
    ...
    self.registerClickHandlers = function() {
      ...
      self.$el.on('change', '[name="salesforce-experiences"]', self.startAutosavingHandler(self.changedExperience));
    };
    ...
    self.updateExpChoices = function($widget, selected) {
      ...
      var $select = $controls.find('[name="salesforce-experiences"]:first');
