apos.define('apostrophe-areas-editor', {
  construct: function(self, options) {
    ...
    self.captureLabelsAndChoices = function() {
      self.choices = [];
      self.labels = {};

      _.each(apos.modules['apostrophe-salesforce-experience'].options.experienceChoices, function(choice) {
        var value = choice.value;
        self.labels[value] = choice.label;
        if (value) {
