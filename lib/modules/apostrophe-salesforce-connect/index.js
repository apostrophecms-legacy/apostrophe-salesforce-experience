        ...
        function (req, res, next) {
          return self.apos.login.passport.authenticate(
            ...
            async function (err, user, info, status) {
              ...
              console.log('👨‍👨‍👧‍👦', req.session.sfUser);
              // TODO: Get the experience and add to req.experiences.
              req.experiences = await getUserExperience(sfExpOptions);
              console.log('getUserExperience', req.experiences);
