...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.setChoices = function () {
      const salesforceConnect = self.apos.modules['apostrophe-salesforce-connect'];
      ...
      if (experienceField) {
        ...
        ].concat(_.map(salesforceConnect.experiences, function (exp) {
          return {
            label: exp.label,
            value: exp.name
          };
    ...
    self.getWidgetClasses = function (widget) {
      ...
      // }
      return superGetWidgetClasses(widget).concat(['apos-area-widget-in-sf-exp']);
    };
